...
public class Newick implements Cloneable {
	...
	public List<Newick> toSortedList(boolean includeDistanceless) {
		...
		if (!includeDistanceless) {
			final List<Newick> distancelessList = new LinkedList<>();
		...
		Collections.sort(
			plainList, new Comparator<Newick>() {
...
//			System.out.println(
//				Newick.parse(
//					"(1:4.306816736322153e-02,2:2.058697096338600e-02,(3:1.734088958589415e-02,((4:2.562712122218737e-02,5:9.790132941891863e-02)0.813:2.109938136975416e-01,6:4.465185560571604e-01)1.000:1.452732275121912e+00)0.711:2.549622811123574e-02);"
//				)
//			);
//
//			List<Double> doubles = Arrays.asList(
//				new Double[] {
//					0.1, 0.5, Double.NaN, 12.3
//				}
//			);
