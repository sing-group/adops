...
//	private static final String OPERATION_RUN_EXPERIMENT = "es.uvigo.ei.sing.adops.operations.runexperimentbysteps";
	...
	public ProjectView(final Project project) {
		...
		this.experimentTab = new HashMap<ProjectExperiment, ExperimentView>();
		this.tabExperiment = new HashMap<ExperimentView, ProjectExperiment>();
...
//		this.add(buttonsPanel, BorderLayout.NORTH);
	...
	private final JXTaskPane createTPProject(final Project project) {
		...
		tpProject.add(new JButton(new AbstractAction("Create Experiment") {
			private static final long serialVersionUID = 1L;
			
			@Override
			public void actionPerformed(ActionEvent e) {
//				Workbench.getInstance().executeOperation(
//					Core.getInstance().getOperationById(ProjectView.OPERATION_CREATE_EXPERIMENT)
//				);
		...
		tpProject.add(new JButton(new AbstractAction("View Fasta File") {
			private static final long serialVersionUID = 1L;
		...
		tpProject.add(new JButton(new AbstractAction("View Names File") {
			private static final long serialVersionUID = 1L;
		...
		tpProject.add(new JButton(new AbstractAction("Check Programs") {
			private static final long serialVersionUID = 1L;
		...
		tpProject.add(new JButton(new AbstractAction("Edit Properties") {
			private static final long serialVersionUID = 1L;
		...
		tpProject.add(new JButton(new AbstractAction("Delete Project") {
			private static final long serialVersionUID = 1L;
	...
	private final JXTaskPane createTPExperiment() {
		...
		this.btnProps.setAction(new ExperimentAction("Edit Properties") {
			private static final long serialVersionUID = 1L;
		...
		this.btnSequences.setAction(new ExperimentAction("Select Sequences") {
			private static final long serialVersionUID = 1L;
		...
		this.btnCheckPrograms.setAction(new ExperimentAction("Check Programs") {
			private static final long serialVersionUID = 1L;
		...
		this.btnCopy.setAction(new ExperimentAction("Copy Experiment") {
			private static final long serialVersionUID = 1L;
		...
		this.btnClean.setAction(new ExperimentAction("Clean Experiment") {
			private static final long serialVersionUID = 1L;
		...
		this.btnLaunch.setAction(new ExperimentAction("Launch") {
			private static final long serialVersionUID = 1L;
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (selection == JOptionPane.YES_OPTION) {
					Workbench.getInstance().executeOperation(
						...
						null,
						Arrays.asList(new Object[] { experiment })
					);
				}
			}
		});
...
//							}
							...
							if (experiment == ProjectView.this.getActiveExperiment()) {
								...
								//										@Override
								//										public void run() {
								//											ProjectView.this.btnProps.setText("View Experiment Properties");
								//											ProjectView.this.btnProps.setEnabled(true);
								//											ProjectView.this.btnCopy.setEnabled(true);
								//										}
								//									});
...
//			this.tabPanel.addTab(experiment.getName(), experimentView);
//			this.tabPanel.addTab(null, experimentView);
//			this.tabPanel.setTabComponentAt(this.tabPanel.getTabCount()-1, this.createTab(experiment.getName()));
//			this.tabPanel.setSelectedComponent(experimentView);
			
//			this.addTab(experiment.getName(), experimentView);
//			this.experimentTab.put(experiment, experimentView);
...
//		}
//
//		public ExperimentAction(String name, Icon icon) {
//			super(name, icon);
//		}
