...
public abstract class CodeMLProcessManager extends ProcessManager {
	...
	static {
		VERSION_MANAGERS = new TreeMap<String, Class<? extends CodeMLProcessManager>>();
...
//		return new CodeMLDefaultProcessManager(configuration);
	}
	
//	public static String createBinaryPath(ExecutableConfiguration configuration) {
