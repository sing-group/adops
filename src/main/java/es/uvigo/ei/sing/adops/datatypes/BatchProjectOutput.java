...
public class BatchProjectOutput extends Observable implements Observer {
	...
	public BatchProjectOutput(BatchProject project) {
		...
		this.projects = new LinkedHashMap<File, Project>();
		this.projectOutputs = new HashMap<Project, ExperimentOutput>();
		this.projectErrors = new HashMap<Project, Throwable>();
	...
	public boolean isFinished() {
		synchronized (this.projects) {
			final Set<Project> projects = new HashSet<Project>(this.projects.values());
